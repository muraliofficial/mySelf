...
export const PROJECTS = [
  {
    name: "Chick Blast",
    badge: "🔥 Featured",
    subtitle: "Full-Stack Web Application (QSR & Food Ordering System)",
    icon: "🍗",
    image: "/chick-blast.png",
    description: "A complete restaurant ordering and management system featuring a customer-facing storefront with live order status tracking, digital menu customization, an admin POS dashboard, real-time Kitchen Display System (KDS), and revenue analytics.",
    stack: ["React.js", "Node.js", "Express.js", "Tailwind CSS v4", "Firebase Firestore"],
    link: "https://chick-blast.vercel.app/admin",
    accent: "#f97316",
